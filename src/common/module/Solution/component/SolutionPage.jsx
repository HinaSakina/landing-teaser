    ...
    <ComponentTransition className="h-auto max-w-[1500px] px-10 xl:px-20 pb-20">
      ...
      <div className="py-10 mt-20 flex gap-10 flex-row justify-center relative flex-wrap">
        ...
        {SolutionAllItem?.map((item, index) => (
          <ComponentTransition
            className="w-full h-[350px] md:basis-[30%] overflow-hidden bg-neutral-100 dark:bg-neutral-950/50 border-[1px] dark:border-neutral-700 border-neutral-300 rounded-3xl"
            key={index}
            delay={index * 0.1}
          >
            <Image
