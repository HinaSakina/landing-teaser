...
import { LLmsProfessionFaqs } from "@/common/constant/Service";
import ComponentTransition from "@/common/component/element/ComponentTransition";
import FaqsHeading from "@/common/component/element/FaqsHeading";
export default function Faqs() {
  const [openStates, setOpenStates] = useState(Array(LLmsProfessionFaqs.length).fill(false));
  ...
  return (
    <ComponentTransition className="flex  rounded-3xl pb-20 justify-center mt-10 items-center flex-col">
      <FaqsHeading />
      {LLmsProfessionFaqs.map((item, index) => (
